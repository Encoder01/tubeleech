...
//
//     final instagramPhotoPrivate = instagramPhotoPrivateFromJson(jsonString);

import 'dart:convert';

InstagramPhotoPrivate instagramPhotoPrivateFromJson(String str) => InstagramPhotoPrivate.fromJson(json.decode(str));

String instagramPhotoPrivateToJson(InstagramPhotoPrivate data) => json.encode(data.toJson());

class InstagramPhotoPrivate {
  InstagramPhotoPrivate({
    this.graphql,
  });

  Graphql graphql;

  factory InstagramPhotoPrivate.fromJson(Map<String, dynamic> json) => InstagramPhotoPrivate(
