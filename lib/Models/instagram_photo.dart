...
//
//     final instagramPhoto = instagramPhotoFromJson(jsonString);

import 'dart:convert';

InstagramPhoto instagramPhotoFromJson(String str) => InstagramPhoto.fromJson(json.decode(str));

String instagramPhotoToJson(InstagramPhoto data) => json.encode(data.toJson());
...
class InstagramPhoto {
  ...
  factory InstagramPhoto.fromJson(Map<String, dynamic> json) => InstagramPhoto(
