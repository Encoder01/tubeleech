...
//
//     final instagramVideo = instagramVideoFromJson(jsonString);

import 'dart:convert';

InstagramVideo instagramVideoFromJson(String str) => InstagramVideo.fromJson(json.decode(str));

String instagramVideoToJson(InstagramVideo data) => json.encode(data.toJson());
...
class InstagramVideo {
  ...
  factory InstagramVideo.fromJson(Map<String, dynamic> json) => InstagramVideo(
