...
//
//     final instagramVideoPrivate = instagramVideoPrivateFromJson(jsonString);

import 'dart:convert';

InstagramVideoPrivate instagramVideoPrivateFromJson(String str) => InstagramVideoPrivate.fromJson(json.decode(str));

String instagramVideoPrivateToJson(InstagramVideoPrivate data) => json.encode(data.toJson());

class InstagramVideoPrivate {
  InstagramVideoPrivate({
    this.graphql,
  });

  Graphql graphql;

  factory InstagramVideoPrivate.fromJson(Map<String, dynamic> json) => InstagramVideoPrivate(
